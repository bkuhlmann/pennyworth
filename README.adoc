...
image:https://www.alchemists.io/images/projects/pennyworth/screenshots/jitsi.png[Hanami workflow screenshot.,width=706,height=254,role=focal_point]
...
2. Type `ror` to view general information, arrow keys to navigate, and `ENTER` to view information.
